    ...
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-xl shadow-sm animate-fade-in-up">
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-2 flex items-center gap-2">
          <Cpu className="w-5 h-5 text-blue-600 dark:text-blue-500" /> Course 3: Sensor Hardware
        </h2>
        ...
        <Accordion title="3.2 Python Host Integration (PySerial)" icon={FileCode2} isOpen={openSection === 1} onClick={() => toggleSection(1)}>
          <div className="space-y-4 text-slate-700 dark:text-slate-300 text-sm sm:text-base leading-relaxed">
            ...
            <div className="bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-lg p-4 font-mono text-xs overflow-x-auto text-slate-800 dark:text-slate-300 mt-2">
              <span className="text-indigo-600 dark:text-indigo-400">import</span> serial<br/>
              <span className="text-indigo-600 dark:text-indigo-400">import</span> json<br/>
              <span className="text-indigo-600 dark:text-indigo-400">import</span> time<br/><br/>
              <span className="text-slate-500"># Open serial connection to the ESP32 sensor</span><br/>
              sensor = serial.Serial(<span className="text-emerald-600 dark:text-emerald-400">'COM3'</span>, baudrate=<span className="text-blue-600 dark:text-blue-400">115200</span>, timeout=<span className="text-blue-600 dark:text-blue-400">1</span>)<br/><br/>
              <span className="text-indigo-600 dark:text-indigo-400">def</span> <span className="text-blue-600 dark:text-blue-400">listen_to_sensor</span>():<br/>
              &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-indigo-600 dark:text-indigo-400">while True</span>:<br/>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-indigo-600 dark:text-indigo-400">if</span> sensor.in_waiting &gt; <span className="text-blue-600 dark:text-blue-400">0</span>:<br/>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;raw_line = sensor.readline().decode(<span className="text-emerald-600 dark:text-emerald-400">'utf-8'</span>).strip()<br/>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-indigo-600 dark:text-indigo-400">try</span>:<br/>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;packet = json.loads(raw_line)<br/>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;process_wids_packet(packet) <span className="text-slate-500"># Send to anomaly engine</span><br/>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-indigo-600 dark:text-indigo-400">except</span> json.JSONDecodeError:<br/>
