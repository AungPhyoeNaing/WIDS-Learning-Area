    ...
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-xl shadow-sm animate-fade-in-up">
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-2 flex items-center gap-2">
          <ShieldAlert className="w-5 h-5 text-red-600 dark:text-red-500" /> Course 4: Physical Deterrence
        </h2>
        ...
        <Accordion title="4.2 Python-to-Hardware Control" icon={FileCode2} isOpen={openSection === 1} onClick={() => toggleSection(1)}>
          <div className="space-y-4 text-slate-700 dark:text-slate-300 text-sm sm:text-base leading-relaxed">
            ...
            <div className="bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-lg p-4 font-mono text-xs overflow-x-auto text-slate-800 dark:text-slate-300 mt-2">
              <span className="text-indigo-600 dark:text-indigo-400">def</span> <span className="text-blue-600 dark:text-blue-400">trigger_physical_alarm</span>(severity_level):<br/>
              &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-indigo-600 dark:text-indigo-400">if</span> severity_level == <span className="text-emerald-600 dark:text-emerald-400">'CRITICAL'</span>:<br/>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-slate-500"># Send serial command to activate the ESP32 buzzer GPIO</span><br/>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sensor.write(<span className="text-emerald-600 dark:text-emerald-400">b"ALARM_ON\n"</span>)<br/>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-blue-600 dark:text-blue-400">print</span>(<span className="text-emerald-600 dark:text-emerald-400">"[!] Critical Attack! Deterrence activated."</span>)<br/>
              &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-indigo-600 dark:text-indigo-400">elif</span> severity_level == <span className="text-emerald-600 dark:text-emerald-400">'WARNING'</span>:<br/>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-slate-500"># Flash warning LEDs only</span><br/>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sensor.write(<span className="text-emerald-600 dark:text-emerald-400">b"LED_WARN\n"</span>)
            </div>
            <p className="mt-4">
