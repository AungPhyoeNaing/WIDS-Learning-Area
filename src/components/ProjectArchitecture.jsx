    ...
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-xl shadow-sm animate-fade-in-up">
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-2 flex items-center gap-2">
          <Layers className="w-5 h-5 text-blue-600 dark:text-blue-500" /> Course 1: WIDS Architecture
        </h2>
      ...
      <div className="space-y-2">
        ...
        <Accordion title="1.2 The End-to-End Data Pipeline" icon={Activity} isOpen={openSection === 1} onClick={() => toggleSection(1)}>
          <div className="space-y-6 text-slate-700 dark:text-slate-300 text-sm sm:text-base leading-relaxed">
            ...
            {/* Visual Pipeline */}
            <div className="flex flex-col sm:flex-row items-center justify-between gap-2 p-4 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl font-mono text-xs sm:text-sm">
              <div className="flex flex-col items-center p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg w-full sm:w-1/4">
                <MonitorPlay className="w-5 h-5 text-emerald-600 dark:text-emerald-400 mb-2" />
                <span className="text-center text-xs">1. Airspace<br/><span className="text-slate-500 text-[10px]">802.11 RF</span></span>
              </div>
              <Cable className="w-4 h-4 text-slate-400 dark:text-slate-700 rotate-90 sm:rotate-0" />
              <div className="flex flex-col items-center p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg w-full sm:w-1/4">
              ...
              <Cable className="w-4 h-4 text-slate-400 dark:text-slate-700 rotate-90 sm:rotate-0" />
              <div className="flex flex-col items-center p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg w-full sm:w-1/4">
                <ShieldCheck className="w-5 h-5 text-rose-600 dark:text-rose-400 mb-2" />
        ...
        <Accordion title="1.3 Dual-Engine Detection Logic" icon={ShieldCheck} isOpen={openSection === 2} onClick={() => toggleSection(2)}>
          <div className="space-y-4 text-slate-700 dark:text-slate-300 text-sm sm:text-base leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mt-4">
              <div className="bg-slate-50 dark:bg-slate-900/50 p-5 rounded-xl border border-slate-200 dark:border-slate-800 border-l-4 border-l-blue-500">
                <h4 className="font-semibold text-slate-800 dark:text-slate-200 mb-2 text-sm sm:text-base">1. Signature-Based</h4>
              ...
              <div className="bg-slate-50 dark:bg-slate-900/50 p-5 rounded-xl border border-slate-200 dark:border-slate-800 border-l-4 border-l-indigo-500">
                <h4 className="font-semibold text-slate-800 dark:text-slate-200 mb-2 text-sm sm:text-base">2. Anomaly-Based</h4>
                <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">
